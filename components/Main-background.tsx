  ...
  return (
    <>
      <div className="flex relative justify-center w-full h-screen">
        ...
        />
        <div className="absolute flex flex-col z-50 items-center gap-25 md:gap-30 top-50">
          <div className="flex flex-col justify-between items-center">
            ...
            <div
              className={`${CormorantGaramond.className} sm:flex sm:flex-col items-center justify-center font-bold text-white lg:text-[110px] md:text-[80px] sm:text-[70px] text-[50px]`}
            >
            ...
            <div className="md:flex flex-col not-last:font-medium lg:text-[20px] sm:text-[16px]  text-[#e6e9e4] items-center justify-center">
              <span className="block md:hidden pt-5 md:pt-0 text-xl text-center">
